      ...
      {project.githubLink === "" ? (
        ...
        >
          <svg
            ...
            height="24"
            viewBox="0 0 24 24"
            className={"w-6 h-6 text-blue-500 fill-zinc400"}
          >
          ...
          <p className="text-light mx-2">Github</p>
        </a>
      )}
      {project.slidesLink === "" ? (
        <></>
        ...
        >
          ...
          <p className="text-light mx-2">Slide deck</p>
        </a>
      )}
      {project.otherLink.src === "" ? (
        <></>
      ) : (
        <a
        ...
        >
          ...
          <p className="text-light mx-2">{project.otherLink.title}</p>
        </a>
      )}
    </div>
  );
